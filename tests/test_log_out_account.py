...
class TestLogOutAccount:
    def tests_lod_out_acc(self, driver):
        ...
        WebDriverWait(driver, 3).until(
            expected_conditions.visibility_of_element_located((By.XPATH, "//div[@class='Auth_login__3hAey']/h2[text()='Вход']")))
        el = driver.find_element(By.XPATH, "//div[@class='Auth_login__3hAey']/h2[text()='Вход']")
        assert el.is_displayed(), "Выход из аккаунта не работает"
